...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8378);
    ...
    const tree = {
        ...
        {
        children: ['', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.t.bind(__webpack_require__, 8112, 23)), "C:\\Users\\Jay-c\\Documents\\like vendas\\like-vendas\\src\\app\\[loja]\\create-produto\\page.tsx"],
    ...
    const pages = ["C:\\Users\\Jay-c\\Documents\\like vendas\\like-vendas\\src\\app\\[loja]\\create-produto\\page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7284))
...
module.exports = createProxy("C:\\Users\\Jay-c\\Documents\\like vendas\\like-vendas\\src\\app\\[loja]\\create-produto\\page.tsx");
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ CreateProduto)
});

// EXTERNAL MODULE: external "next/dist/compiled/react/jsx-runtime"
var jsx_runtime_ = __webpack_require__(6786);
// EXTERNAL MODULE: ./src/components/headerPageSecond.tsx
var headerPageSecond = __webpack_require__(2425);
...
;// CONCATENATED MODULE: ./src/controlles/createProduto.ts
async function createProduto({ name , preco , quat , emailDaLoja  }) {
...
// EXTERNAL MODULE: ./src/controlles/getProdutos.ts
var getProdutos = __webpack_require__(961);
;// CONCATENATED MODULE: ./src/components/mainPageCreateProduto.tsx
...
function MainPageCreateProduto({ email  }) {
    async function senProduto() {
        if (name.length !== 0 && preco.length !== 0) {
            ...
            const res1 = await (0,getProdutos/* getProdutos */.V)(email);
            const l = res1.length;
    ...
    const [preco, setPreco] = (0,react_.useState)("");
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("main", {
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: "flex items-center justify-center flex-col gap-16 min-h-[50vh] md:min-h-[60vh]",
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("h1", {
                        className: "pl-6 md:pl-1 text-2xl self-start",
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: "fixed bottom-10 left-5 text-xs",
                children: "Limite de produtos 1.000"
            })
        ]
    });
}

// EXTERNAL MODULE: ./src/components/verificarPage.tsx + 1 modules
var verificarPage = __webpack_require__(989);
;// CONCATENATED MODULE: ./src/app/[loja]/create-produto/page.tsx
...
function CreateProduto() {
    (0,verificarPage/* VerificarPage */.w)();
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(headerPageSecond/* HeaderPageSecond */.p, {
                email: email
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(MainPageCreateProduto, {
                email: email
            })
        ]
    });
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "p": () => (/* binding */ HeaderPageSecond)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6786);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var phosphor_react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5849);
/* harmony import */ var next_link__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1621);
/* harmony import */ var next_link__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(next_link__WEBPACK_IMPORTED_MODULE_1__);



function HeaderPageSecond({ email  }) {
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("header", {
        className: "w-full p-3 flex items-center justify-between md:w-[80%] md:py-4",
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_1___default()), {
                href: `/${email}/dashbord`,
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(phosphor_react__WEBPACK_IMPORTED_MODULE_2__/* .ArrowLeft */ .XdH, {
                    size: 64,
                    className: "p-3 hover:text-white hover:bg-blue-500 rounded-lg"
                })
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_1___default()), {
                href: `/${email}/loja`,
                className: "flex flex-col items-end gap-3 hover:text-blue-500",
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(phosphor_react__WEBPACK_IMPORTED_MODULE_2__/* .UserCircle */ .Ys9, {
                    size: 48
                })
            })
        ]
...
var __webpack_exports__ = __webpack_require__.X(0, [359,127,233,339,263,362], () => (__webpack_exec__(1571)));
